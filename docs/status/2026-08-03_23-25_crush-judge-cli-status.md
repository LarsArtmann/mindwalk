...
**1.** What makes Crush safe as a judge without tool-stripping flags? You told me it's safe, and I believe you — but I can't document _why_ in the code comment without understanding the mechanism. Is it a sandbox? A tool router that gates non-interactive runs? Something else? One sentence and I'll write the comment.
