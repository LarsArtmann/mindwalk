  ...
  const events = [
    {
      ...
      targets: [{ path: "src/lib/parser.ts", touch: "hit" as const }],
      resultBytes: 1200,
      isError: false,
    ...
    },
    {
      ...
      targets: [{ path: "src/lib/parser.ts", touch: "read" as const }],
      resultBytes: 5100,
      isError: false,
    ...
    },
    {
      ...
      tool: "Read",
      action: "read" as const,
      targets: [{ path: "src/lib/config.ts", touch: "read" as const }],
      resultBytes: 1500,
      isError: false,
    ...
    },
    {
      ...
      tool: "Read",
      action: "read" as const,
      targets: [{ path: "src/app.ts", touch: "read" as const }],
      resultBytes: 6200,
      isError: false,
    ...
    },
    {
      ...
      tool: "Read",
      action: "read" as const,
      targets: [{ path: "src/ui/Modal.tsx", touch: "read" as const }],
      resultBytes: 2100,
      isError: false,
      ...
      targets: [
        {
          path: "src/app.ts",
          touch: "edit" as const,
          lines: [[100, 120] as [number, number]],
        },
      ],
      resultBytes: 900,
      isError: false,
    ...
    },
    {
      ...
      tool: "Read",
      action: "read" as const,
      targets: [{ path: "tests/parser.test.ts", touch: "read" as const }],
      resultBytes: 3200,
      isError: false,
    ...
    },
    {
      ...
      tool: "Read",
      action: "read" as const,
      targets: [{ path: "src/ui/Button.tsx", touch: "read" as const }],
      resultBytes: 900,
      isError: false,
    ...
    },
    {
      ...
      tool: "Grep",
      action: "search" as const,
      targets: [{ path: "src/api/client.ts", touch: "hit" as const }],
      resultBytes: 300,
      isError: false,
    ...
    },
    {
      ...
      tool: "Read",
      action: "read" as const,
      targets: [{ path: "src/api/client.ts", touch: "read" as const }],
      resultBytes: 3800,
      isError: false,
